...
contract Treasury is ITreasury, ContractGuard, ReentrancyGuard {
    ...
    // 28 first epochs (1 week) with 1.5% expansion regardless of maintoken price
    ...
    uint256 public override daoFundSharedPercent; 

    address public override marketingFund;
    uint256 public override marketingFundSharedPercent;
    ...
    function initialize(
        ...
        bootstrapEpochs = 28;
        bootstrapSupplyExpansionPercent = 150;// 1.5%

        // set seigniorageSaved to it's balance
        seigniorageSaved = IERC20(maintoken).balanceOf(address(this));

        nextSupplyTarget = 5000000 ether; // 5B supply is the next target to reduce expansion rate
        ...
        nonReentrant
    {
        ...
        allocateSeigniorageSalary = 5 ether; // 1000 maintoken salary for calling allocateSeigniorage()
